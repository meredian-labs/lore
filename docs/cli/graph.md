...
- [`lore log --all`](./log) — flat tree view grouped by node
- [`lore why`](./why) — all blobs for a specific file
- [`lore node list`](../cli/node) — list all subsystem nodes
- [Architecture: Knowledge Graph](../architecture/storage) — graph tier explanation
