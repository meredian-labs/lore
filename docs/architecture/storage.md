...
- [Schema](./schema) — all SQLite table definitions
- [Trust Model](./trust-model) — trust levels in detail
- [Storage architecture](/architecture/storage) — internal storage rules reference
