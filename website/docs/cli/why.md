...
- For a chronological view (oldest first), use [`lore trace`](./trace.md).

## See Also

- [`lore trace`](./trace.md) — chronological file history (oldest first)
- [`lore show`](./show.md) — full blob detail
