...
- [Storage Architecture](./storage.md) — observed vs. inferred storage rule
- [Schema](./schema.md) — `trust_level` and `ai_source` column definitions
- [AI integration concepts](../agents/custom-agent.md) — internal AI model responsibility rules
